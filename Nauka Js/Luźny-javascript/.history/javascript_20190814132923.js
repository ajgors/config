...
// let tvShows = [{name: 'games of throne'}, {name: 'SImpsons'}]
...
// let fetchTv = new Promise((resolve,reject) =>{
//   let rand = Math.floor(Math.random() * 2);

//   rand ? resolve(todos) : reject({status: 'error', message:'Oops!'});
// });

// fetchTv.then(resolve).catch(rejected);
...
const todos = fetch('https://jsonplaceholder.typicode.com/todoss');
...
todosobject.then(response => console.log(response.formData));
