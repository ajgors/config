...
class Admin extends User{
  deleteUser(user){
    users = users.filter((user) =>{
      return urls.username !== user.username
    })
  }
}

const userOne = new User('mario', '@wp.pl')
const userTwo = new User('igor', '@gmail.com')
const userThree = new Admin('ola', '@wp.pl')
// console.log(userThree)

// userOne.login().incScore().incScore().loged()
// userTwo.loged()
